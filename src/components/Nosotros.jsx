...
function Nosotros() {
  return (
    ...
    <div className="container-nosotros">
      <div className="desc">
        <div className="des__img"> <img src={img1} alt="foto1" /></div>
      ...
      <div className="desc">
      <div className="des__img"><img src={img2} alt="foto2" /></div>
      ...
      <div className="desc">
      <div className="des__img"> <img src={img3} alt="foto3" /></div>
      ...
      <div className="desc">
      <div className="des__img"><img src={img4} alt="foto4" /></div>
